...
class Perm {
  ...
  static const _notifAccessChannel =
      MethodChannel('com.hollow.perm/notification_access');
  ...
  static Future<bool> isNotificationAccessGranted() async {
    try {
      final granted =
          await _notifAccessChannel.invokeMethod<bool>('isNotificationAccessGranted');
  ...
  static Future<void> openNotificationAccessSettings() async {
    try {
      await _notifAccessChannel.invokeMethod('openNotificationAccessSettings');
    } on PlatformException catch (e) {
