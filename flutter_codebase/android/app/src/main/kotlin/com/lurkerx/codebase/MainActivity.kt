...
class MainActivity : FlutterActivity() {
    ...
    private val NOTIF_CHANNEL = "com.lurkerx.codebase/notifications"
    private val NOTIF_EVENT_CHANNEL = "com.lurkerx.codebase/notifications_stream"
    private val NOTIF_ACCESS_CHANNEL = "com.hollow.perm/notification_access"
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, NOTIF_ACCESS_CHANNEL)
        .setMethodCallHandler { call, result ->
            when (call.method) {
                "isNotificationAccessGranted" -> {
                    ...
                    val granted = enabledListeners != null &&
